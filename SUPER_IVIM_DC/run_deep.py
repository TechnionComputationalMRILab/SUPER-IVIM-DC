...
from SUPER_IVIM_DC.utils.hyperparams import hyperparams as hp_example
from SUPER_IVIM_DC.simulations.sim_signal import sim_signal
from SUPER_IVIM_DC.utils.checkarg import checkarg
from SUPER_IVIM_DC.visualization.boxplot_ivim import boxplot_ivim
from SUPER_IVIM_DC.inference.supervised_ivim import infer_supervised_IVIM
...
for n_samples in sample_size:
    ...
    IVIMNET_path = Path(f'{DIR_PATH}/saved/models/IVIMNET/sim/SNR_010.pt')
    IVIMSUPER_path = Path(f'{DIR_PATH}/saved/models/SUPERIVIMDC/sim/SNR010.pt')
